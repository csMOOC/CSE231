...
@Totalmap = global %"class.std::map" zeroinitializer, align 8
@__dso_handle = external unnamed_addr global i8
@Truemap = global %"class.std::map" zeroinitializer, align 8
@.str = private unnamed_addr constant [30 x i8] c"Function\09\09Bias \09Taken\09Total \0A\00", align 1
@.str2 = private unnamed_addr constant [12 x i8] c"%s\09%f\09%d\09%d\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()* }] [{ i32, void ()* } { i32 65535, void ()* @_GLOBAL__I_a }]

define internal void @__cxx_global_var_init() section ".text.startup" {
entry:
  call void @_ZNSt3mapISsiSt4lessISsESaISt4pairIKSsiEEEC2Ev(%"class.std::map"* @Totalmap)
  %0 = call i32 @__cxa_atexit(void (i8*)* bitcast (void (%"class.std::map"*)* @_ZNSt3mapISsiSt4lessISsESaISt4pairIKSsiEEED2Ev to void (i8*)*), i8* getelementptr inbounds (%"class.std::map"* @Totalmap, i32 0, i32 0, i32 0, i32 0, i32 0), i8* @__dso_handle) #2
  ret void
}
...
entry:
  call void @_ZNSt3mapISsiSt4lessISsESaISt4pairIKSsiEEEC2Ev(%"class.std::map"* @Truemap)
  %0 = call i32 @__cxa_atexit(void (i8*)* bitcast (void (%"class.std::map"*)* @_ZNSt3mapISsiSt4lessISsESaISt4pairIKSsiEEED2Ev to void (i8*)*), i8* getelementptr inbounds (%"class.std::map"* @Truemap, i32 0, i32 0, i32 0, i32 0, i32 0), i8* @__dso_handle) #2
  ret void
}

; Function Attrs: uwtable
define void @_Z17collectBranchInfoPcb(i8* %fname, i1 zeroext %f) #0 {
entry:
  ...
  %0 = load i8** %fname.addr, align 8
  call void @_ZNSaIcEC1Ev(%"class.std::allocator.0"* %ref.tmp) #2
  invoke void @_ZNSsC1EPKcRKSaIcE(%"class.std::basic_string"* %Fname, i8* %0, %"class.std::allocator.0"* %ref.tmp)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  call void @_ZNSaIcED1Ev(%"class.std::allocator.0"* %ref.tmp) #2
  %call = invoke i32* @_ZNSt3mapISsiSt4lessISsESaISt4pairIKSsiEEEixERS3_(%"class.std::map"* @Totalmap, %"class.std::basic_string"* %Fname)
          to label %invoke.cont2 unwind label %lpad1

invoke.cont2:                                     ; preds = %invoke.cont
  %1 = load i32* %call
  %inc = add nsw i32 %1, 1
  store i32 %inc, i32* %call
  %2 = load i8* %f.addr, align 1
  %tobool = trunc i8 %2 to i1
  br i1 %tobool, label %if.then, label %if.end

if.then:                                          ; preds = %invoke.cont2
  %call4 = invoke i32* @_ZNSt3mapISsiSt4lessISsESaISt4pairIKSsiEEEixERS3_(%"class.std::map"* @Truemap, %"class.std::basic_string"* %Fname)
...
if.end:                                           ; preds = %invoke.cont3, %invoke.cont2
  call void @_ZNSsD1Ev(%"class.std::basic_string"* %Fname)
  ret void
...
entry:
  ...
  %call1 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapISsiSt4lessISsESaISt4pairIKSsiEEE5beginEv(%"class.std::map"* @Totalmap)
...
for.cond:                                         ; preds = %for.inc, %entry
  %call2 = call %"struct.std::_Rb_tree_node_base"* @_ZNSt3mapISsiSt4lessISsESaISt4pairIKSsiEEE3endEv(%"class.std::map"* @Totalmap)
  %coerce.dive3 = getelementptr %"struct.std::_Rb_tree_iterator"* %ref.tmp, i32 0, i32 0
  store %"struct.std::_Rb_tree_node_base"* %call2, %"struct.std::_Rb_tree_node_base"** %coerce.dive3
  %call4 = call zeroext i1 @_ZNKSt17_Rb_tree_iteratorISt4pairIKSsiEEneERKS3_(%"struct.std::_Rb_tree_iterator"* %it, %"struct.std::_Rb_tree_iterator"* %ref.tmp)
  br i1 %call4, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %call5 = call %"struct.std::pair"* @_ZNKSt17_Rb_tree_iteratorISt4pairIKSsiEEptEv(%"struct.std::_Rb_tree_iterator"* %it)
  %second = getelementptr inbounds %"struct.std::pair"* %call5, i32 0, i32 1
  %0 = load i32* %second, align 4
  store i32 %0, i32* %total, align 4
  %call6 = call %"struct.std::pair"* @_ZNKSt17_Rb_tree_iteratorISt4pairIKSsiEEptEv(%"struct.std::_Rb_tree_iterator"* %it)
  %first = getelementptr inbounds %"struct.std::pair"* %call6, i32 0, i32 0
  call void @_ZNSsC1ERKSs(%"class.std::basic_string"* %fname, %"class.std::basic_string"* %first)
  %call7 = invoke i64 @_ZNKSt3mapISsiSt4lessISsESaISt4pairIKSsiEEE5countERS3_(%"class.std::map"* @Truemap, %"class.std::basic_string"* %fname)
          to label %invoke.cont unwind label %lpad
...
cond.true:                                        ; preds = %invoke.cont
  %call9 = invoke i32* @_ZNSt3mapISsiSt4lessISsESaISt4pairIKSsiEEEixERS3_(%"class.std::map"* @Truemap, %"class.std::basic_string"* %fname)
...
cond.end:                                         ; preds = %cond.false, %invoke.cont8
  %cond = phi i32 [ %1, %invoke.cont8 ], [ 0, %cond.false ]
  store i32 %cond, i32* %taken, align 4
  %2 = load i32* %taken, align 4
  ...
  store float %conv11, float* %bias, align 4
  %call13 = invoke i8* @_ZNKSs5c_strEv(%"class.std::basic_string"* %fname)
          to label %invoke.cont12 unwind label %lpad

invoke.cont12:                                    ; preds = %cond.end
  %4 = load float* %bias, align 4
  %conv14 = fpext float %4 to double
  %5 = load i32* %taken, align 4
  %6 = load i32* %total, align 4
  %call16 = invoke i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str2, i32 0, i32 0), i8* %call13, double %conv14, i32 %5, i32 %6)
...
for.inc:                                          ; preds = %invoke.cont15
  %call18 = call %"struct.std::_Rb_tree_iterator"* @_ZNSt17_Rb_tree_iteratorISt4pairIKSsiEEppEv(%"struct.std::_Rb_tree_iterator"* %it)
  br label %for.cond

lpad:                                             ; preds = %invoke.cont12, %cond.end, %cond.true, %for.body
  %7 = landingpad { i8*, i32 } personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*)
          cleanup
  %8 = extractvalue { i8*, i32 } %7, 0
  store i8* %8, i8** %exn.slot
...
; Function Attrs: uwtable
define linkonce_odr i64 @_ZNKSt3mapISsiSt4lessISsESaISt4pairIKSsiEEE5countERS3_(%"class.std::map"* %this, %"class.std::basic_string"* %__x) #0 align 2 {
entry:
  %this.addr = alloca %"class.std::map"*, align 8
...
; Function Attrs: uwtable
define linkonce_odr %"struct.std::_Rb_tree_node_base"* @_ZNKSt8_Rb_treeISsSt4pairIKSsiESt10_Select1stIS2_ESt4lessISsESaIS2_EE4findERS1_(%"class.std::_Rb_tree"* %this, %"class.std::basic_string"* %__k) #0 align 2 {
entry:
...
; Function Attrs: nounwind uwtable
define linkonce_odr zeroext i1 @_ZNKSt23_Rb_tree_const_iteratorISt4pairIKSsiEEeqERKS3_(%"struct.std::_Rb_tree_const_iterator"* %this, %"struct.std::_Rb_tree_const_iterator"* %__x) #6 align 2 {
entry:
...
; Function Attrs: uwtable
define linkonce_odr %"struct.std::_Rb_tree_node_base"* @_ZNKSt8_Rb_treeISsSt4pairIKSsiESt10_Select1stIS2_ESt4lessISsESaIS2_EE3endEv(%"class.std::_Rb_tree"* %this) #0 align 2 {
entry:
  %retval = alloca %"struct.std::_Rb_tree_const_iterator", align 8
  %this.addr = alloca %"class.std::_Rb_tree"*, align 8
  store %"class.std::_Rb_tree"* %this, %"class.std::_Rb_tree"** %this.addr, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr void @_ZNSt23_Rb_tree_const_iteratorISt4pairIKSsiEEC2EPKSt13_Rb_tree_nodeIS2_E(%"struct.std::_Rb_tree_const_iterator"* %this, %"struct.std::_Rb_tree_node"* %__x) unnamed_addr #6 align 2 {
entry:
  %this.addr = alloca %"struct.std::_Rb_tree_const_iterator"*, align 8
...
; Function Attrs: uwtable
define linkonce_odr %"struct.std::_Rb_tree_node_base"* @_ZNKSt8_Rb_treeISsSt4pairIKSsiESt10_Select1stIS2_ESt4lessISsESaIS2_EE14_M_lower_boundEPKSt13_Rb_tree_nodeIS2_ESC_RS1_(%"class.std::_Rb_tree"* %this, %"struct.std::_Rb_tree_node"* %__x, %"struct.std::_Rb_tree_node"* %__y, %"class.std::basic_string"* %__k) #0 align 2 {
entry:
  %retval = alloca %"struct.std::_Rb_tree_const_iterator", align 8
  %this.addr = alloca %"class.std::_Rb_tree"*, align 8
  %__x.addr = alloca %"struct.std::_Rb_tree_node"*, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::_Rb_tree_node"* @_ZNKSt8_Rb_treeISsSt4pairIKSsiESt10_Select1stIS2_ESt4lessISsESaIS2_EE8_M_beginEv(%"class.std::_Rb_tree"* %this) #6 align 2 {
entry:
  %this.addr = alloca %"class.std::_Rb_tree"*, align 8
  store %"class.std::_Rb_tree"* %this, %"class.std::_Rb_tree"** %this.addr, align 8
  %this1 = load %"class.std::_Rb_tree"** %this.addr
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::_Rb_tree_node"* @_ZNKSt8_Rb_treeISsSt4pairIKSsiESt10_Select1stIS2_ESt4lessISsESaIS2_EE6_M_endEv(%"class.std::_Rb_tree"* %this) #6 align 2 {
entry:
  %this.addr = alloca %"class.std::_Rb_tree"*, align 8
  store %"class.std::_Rb_tree"* %this, %"class.std::_Rb_tree"** %this.addr, align 8
  %this1 = load %"class.std::_Rb_tree"** %this.addr
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeISsSt4pairIKSsiESt10_Select1stIS2_ESt4lessISsESaIS2_EE7_S_leftEPKSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %__x) #6 align 2 {
entry:
  %__x.addr = alloca %"struct.std::_Rb_tree_node_base"*, align 8
  store %"struct.std::_Rb_tree_node_base"* %__x, %"struct.std::_Rb_tree_node_base"** %__x.addr, align 8
  %0 = load %"struct.std::_Rb_tree_node_base"** %__x.addr, align 8
...
; Function Attrs: nounwind uwtable
define linkonce_odr %"struct.std::_Rb_tree_node"* @_ZNSt8_Rb_treeISsSt4pairIKSsiESt10_Select1stIS2_ESt4lessISsESaIS2_EE8_S_rightEPKSt18_Rb_tree_node_base(%"struct.std::_Rb_tree_node_base"* %__x) #6 align 2 {
entry:
  %__x.addr = alloca %"struct.std::_Rb_tree_node_base"*, align 8
  store %"struct.std::_Rb_tree_node_base"* %__x, %"struct.std::_Rb_tree_node_base"** %__x.addr, align 8
  %0 = load %"struct.std::_Rb_tree_node_base"** %__x.addr, align 8
